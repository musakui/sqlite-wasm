...
export const isTypedArray = (v) => (v?.constructor && isInt32(v.constructor.BYTES_PER_ELEMENT) ? v : false)

export const typedArrayPart = (arr, s, e) => (arr.buffer instanceof SharedArrayBuffer ? arr.slice(s, e) : arr.subarray(s, e))
...
export const typedArrayToString = (typedArray, begin, end) => DECODER.decode(typedArrayPart(typedArray, begin, end))
