...
export const onReady = (exported) => {
	...
	function sqlite3ApiBootstrap() {
		...
		wasm.pstack = Object.assign(Object.create(null), {
			restore: asm.sqlite3_wasm_pstack_restore,
			alloc: function (n) {
				if ('string' === typeof n && !(n = wasm.sizeofIR(n))) {
					WasmAllocError.toss('Invalid value for pstack.alloc(', arguments[0], ')')
				}
				return asm.sqlite3_wasm_pstack_alloc(n) || WasmAllocError.toss('Could not allocate', n, 'bytes from the pstack.')
			},
		...
		Object.defineProperties(wasm.pstack, {
			pointer: {
				...
				iterable: true,
				writeable: false,
				get: asm.sqlite3_wasm_pstack_ptr,
			},
			quota: {
				configurable: false,
				iterable: true,
				writeable: false,
				get: asm.sqlite3_wasm_pstack_quota,
			},
			remaining: {
				configurable: false,
				iterable: true,
				writeable: false,
				get: asm.sqlite3_wasm_pstack_remaining,
			},
		})
