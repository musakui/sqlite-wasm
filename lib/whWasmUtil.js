import { getMemory } from './instance.js'
import { xWrap, xGet, xCall, xArg, xResult } from './binding.js'
...
export function WhWasmUtilInstaller(target) {
	...
	target.scopedAlloc = heap.scopedAlloc
	target.scopedAllocPop = heap.scopedAllocPop
	target.scopedAllocPush = heap.scopedAllocPush
