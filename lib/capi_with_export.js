...
export const alloc = (n) => exports.sqlite3_malloc(n) || WasmAllocError.toss(`Failed to allocate ${n} bytes`)

export const realloc = (m, n) => (n ? exports.sqlite3_realloc(m, n) || WasmAllocError.toss(`Failed to reallocate ${n} bytes`) : 0)
