import { capi, wasm, sqliteError, SQLite3Error, AllocError } from './init.js'
import { isPtr } from './util.js'
import * as heap from './heap.js'
import * as logger from './logger.js'
import { StructBinder } from './setup.js'
...
export const installStruct = (sqlite3) => {
	...
	vtab.xError = function f(methodName, err, defaultRc) {
		...
		let rc
		if (err instanceof AllocError) rc = capi.SQLITE_NOMEM
						...
						return function (pDb, pAux, argc, argv, ppVtab, pzErr) {
							try {
								...
								if (!(e instanceof AllocError)) {
									...
									wasm.pokePtr(pzErr, heap.allocCString(e.message))
								}
