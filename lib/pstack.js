import { getExports, allocError } from './init.js'
...
export const alloc = (n) => {
	...
	return getExports().sqlite3_wasm_pstack_alloc(n) || allocError(`Could not allocate ${n} bytes from the pstack`)
}
...
export const restore = (n) => getExports().sqlite3_wasm_pstack_restore(n)

export const getPtr = () => getExports().sqlite3_wasm_pstack_ptr

export const getQuota = () => getExports().sqlite3_wasm_pstack_quota

export const getRemaining = () => getExports().sqlite3_wasm_pstack_remaining
