import { instance, allocError } from './init.js'
...
export const alloc = (n) => {
	...
	return instance?.exports.sqlite3_wasm_pstack_alloc(n) || allocError(`Could not allocate ${n} bytes from the pstack`)
}
...
export const restore = (n) => instance?.exports.sqlite3_wasm_pstack_restore(n)

export const getPtr = () => instance?.exports.sqlite3_wasm_pstack_ptr

export const getQuota = () => instance?.exports.sqlite3_wasm_pstack_quota

export const getRemaining = () => instance?.exports.sqlite3_wasm_pstack_remaining
