...
import { capi, wasm, SQLite3Error } from './init.js'
import { sqlite3_values_to_js } from './capi_extras.js'
import { sqlite3_wasm_db_error } from './capi_extras_with_export.js'
		...
		const __cfProxy = Object.assign(Object.create(null), {
			...
			xFunc: {
				...
				callProxy: (callback) => {
					return (pCtx, argc, pArgv) => {
						try {
							capi.sqlite3_result_js(pCtx, callback(pCtx, ...sqlite3_values_to_js(argc, pArgv)))
						} catch (e) {
							capi.sqlite3_result_error_js(pCtx, e)
						}
					}
