...
import { capi, wasm, SQLite3Error, getMemory } from './init.js'
import {
...
export const installWhWasm = (sqlite3, exports) => {
	wasm.allocFromTypedArray = function (src) {
		...
		if (!utils.isBindableTypedArray(src)) SQLite3Error.toss('Value is not of a supported TypedArray type.')
	...
	Object.assign(wasm, {
		exports,
		memory: getMemory(),
		alloc: (n) => exports.sqlite3_malloc(n) || WasmAllocError.toss(`Failed to allocate ${n} bytes`),
...

	{
		const flexibleString = function (v) {
			...
			return wasm.isPtr(v) ? wasm.cstrToJs(v) : v
		}
		...
		wasm.xWrap.argAdapter('sqlite3_filename', __xArgPtr)('sqlite3_context*', __xArgPtr)('sqlite3_value*', __xArgPtr)('void*', __xArgPtr)(
			...
			if ('string' === typeof v) return capi.sqlite3_vfs_find(v) || SQLite3Error.toss(capi.SQLITE_NOTFOUND, 'Unknown sqlite3_vfs name:', v)
