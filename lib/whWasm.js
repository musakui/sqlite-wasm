...
import { alloc, capi, wasm, sqliteError, C_API, structs } from './base.js'
...
export const installWhWasm = (sqlite3) => {
...

	{
		...
		wasm.xWrap.argAdapter('sqlite3_filename', __xArgPtr)('sqlite3_context*', __xArgPtr)('sqlite3_value*', __xArgPtr)('void*', __xArgPtr)(
			...
			__xArgPtr(v instanceof (structs.sqlite3_index_info || nilType) ? v.pointer : v)
		)('sqlite3_module*', (v) => __xArgPtr(v instanceof (structs.sqlite3_module || nilType) ? v.pointer : v))('sqlite3_vfs*', (v) => {
			if ('string' === typeof v) return capi.sqlite3_vfs_find(v) || sqliteError(C_API.SQLITE_NOTFOUND, 'Unknown sqlite3_vfs name:', v)
			return __xArgPtr(v instanceof (structs.sqlite3_vfs || nilType) ? v.pointer : v)
		})
...

	{
		...
		capi.sqlite3_auto_extension = function (fPtr) {
			...
			const rc = asm.sqlite3_auto_extension(fPtr)
			if (fPtr !== arguments[0]) {
		...
		capi.sqlite3_reset_auto_extension = function () {
			asm.sqlite3_reset_auto_extension()
